...
export default function TISimplificadoDashboard({
  ...
  const irsLiquido = capReembolso(irsEstimado - deducoes - retencoes);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="col-span-12 grid grid-cols-5 gap-3 auto-rows-fr">
        {kpis.map((k) => (
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {retencoesSource !== "auto" && (
              <label className="flex items-center gap-2 text-sm">
                <span className="text-muted-foreground">Retenção na fonte e pagamentos por conta</span>
                <input
                  type="number"
                  step="0.01"
